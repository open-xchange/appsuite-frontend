...
for LANG in ca_ES cs_CZ da_DK de_DE en_GB en_US es_ES es_MX et_EE fi_FI fr_CA fr_FR hu_HU it_IT ja_JP lv_LV nb_NO nl_NL pl_PL pt_BR ro_RO ru_RU sk_SK sv_SE tr_TR zh_CN zh_TW; do
...
%dir /opt/open-xchange/etc/languages
%dir /opt/open-xchange/etc/languages/appsuite
/opt/open-xchange/appsuite/apps/*/*.tr_TR.js
/opt/open-xchange/appsuite/apps/*/*/*.tr_TR.js
/opt/open-xchange/appsuite/apps/*/*/*/*.tr_TR.js
...
* Mon May 25 2020 Markus Wagner <markus.wagner@open-xchange.com>
Build for patch 2020-05-26 (5741)
* Fri May 08 2020 Markus Wagner <markus.wagner@open-xchange.com>
Build for patch 2020-05-11 (5719)
* Thu Apr 09 2020 Markus Wagner <markus.wagner@open-xchange.com>
Build for patch 2020-04-14 (5676)
* Mon Mar 23 2020 Markus Wagner <markus.wagner@open-xchange.com>
Build for patch 2020-03-23 (5652)
* Thu Mar 05 2020 Markus Wagner <markus.wagner@open-xchange.com>
Build for patch 2020-03-02 (5622)
* Fri Feb 07 2020 Markus Wagner <markus.wagner@open-xchange.com>
Build for patch 2020-02-10 (5571)
* Tue Jan 14 2020 Markus Wagner <markus.wagner@open-xchange.com>
Build for patch 2020-01-20 (5546)
* Mon Dec 02 2019 Markus Wagner <markus.wagner@open-xchange.com>
Build for patch 2019-12-09 (5509)
* Tue Nov 19 2019 Markus Wagner <markus.wagner@open-xchange.com>
Build for patch 2019-11-25 (5484)
* Mon Nov 04 2019 Markus Wagner <markus.wagner@open-xchange.com>
...
* Tue Sep 10 2019 Markus Wagner <markus.wagner@open-xchange.com>
Build for patch 2019-09-09 (5397)
* Mon Sep 09 2019 Markus Wagner <markus.wagner@open-xchange.com>
Build for patch 2019-09-10 (5409)
* Thu Aug 22 2019 Markus Wagner <markus.wagner@open-xchange.com>
Build for patch 2019-08-26 (5374)
* Fri Aug 09 2019 Markus Wagner <markus.wagner@open-xchange.com>
Build for patch 2019-08-12 (5359)
* Mon Jul 22 2019 Markus Wagner <markus.wagner@open-xchange.com>
Build for patch 2019-07-29 (5341)
* Tue Jul 09 2019 Markus Wagner <markus.wagner@open-xchange.com>
Build for patch 2019-07-15 (5310)
* Mon Jun 24 2019 Markus Wagner <markus.wagner@open-xchange.com>
Build for patch 2019-07-01 (5291)
* Mon Jun 03 2019 Markus Wagner <markus.wagner@open-xchange.com>
Build for patch 2019-06-11 (5261)
* Fri May 10 2019 Markus Wagner <markus.wagner@open-xchange.com>
First candidate of 7.10.2 release
* Wed May 01 2019 Markus Wagner <markus.wagner@open-xchange.com>
Second preview of 7.10.2 release
* Thu Mar 28 2019 Markus Wagner <markus.wagner@open-xchange.com>
First preview of 7.10.2 release
* Mon Mar 11 2019 Markus Wagner <markus.wagner@open-xchange.com>
prepare for 7.10.2
* Wed Nov 28 2018 Markus Wagner <markus.wagner@open-xchange.com>
Second candidate for 7.10.1 release
* Fri Nov 23 2018 Markus Wagner <markus.wagner@open-xchange.com>
RC 1 for 7.10.1 release
* Fri Nov 02 2018 Markus Wagner <markus.wagner@open-xchange.com>

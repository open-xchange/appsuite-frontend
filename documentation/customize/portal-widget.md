...
Check whether your plugin only [works when a certain module is active]({{ site.baseurl }}/ui/customize/manifests.html).
Also, maybe we can interest you in [preparing the text for readers from other countries]({{ site.baseurl }}/ui/how-to/i18n.html)?

...
define('io.ox/tours/intro', [
    ...
    Tour.registry.add({
        ...
        var tour = new Tour({
            ...
            .hotspot('#io-ox-launcher .dropdown-toggle svg', { top: 9, left: 9 })
        ...
        if (ext.point('io.ox/core/appcontrol/right/settings').list().length > 1) {
            tour.step({ back: false, noAutoAlign: true })
                ...
                .hotspot('#io-ox-topbar-settings-dropdown-icon svg', { top: 9, left: 10 })
            ...
            tour.step({ back: false, noAutoAlign: true })
                .title(gt('Settings'))
                .content(gt('Customize the product to your needs in the settings area.'))
                .hotspot('#io-ox-settings-topbar-icon svg', { top: 9, left: 10 })
        ...
        tour.step({ back: false, noAutoAlign: true })
            ...
            .hotspot('#io-ox-topbar-help-dropdown-icon svg', { top: 12, left: 12 })

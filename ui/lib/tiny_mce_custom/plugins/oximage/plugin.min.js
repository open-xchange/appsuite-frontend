    ...
    editor.addButton('image', {
        ...
        onPostRender: function () {
            var form = $('<form>', {
                    ...
                    role: 'presentation',
                    tabindex: -1
                }).addClass('mce-widget mce-btn mce-last btn-file'),
                gguid = _.uniqueId('form-control-label-');
            form.append(
                $('<i>').addClass('mce-ico mce-i-image').css('padding', '4px 10px'),
                $('<label>').attr('for', gguid).addClass('sr-only'),
                $('<input name="file" type="file" class="file-input">').attr({ id: gguid }).on('change', function () {
                    var file = $(this);

...
(function(b) {
    ...
    function f() {
        ...
        b.each(["remove", "replaceWith", "replaceAll", "empty"],
                function(m, l) {
                    var n = j[l] = b.fn[l];
                    b.fn[l] = function() {
                        i.call(this, l);
        ...
        b.fn.attr = function(n, q, o) {
            var m = this;
            if ((!n) || (n !== "value") || (!g(m))) {
                return j.attr.apply(m, arguments);
            }
            if (q !== e) {
                k.call(m.filter(":tinymce"), q);
                j.attr.apply(m.not(":tinymce"), arguments);
                return m
            } else {
                var p = m[0], l = h(p);
                return l ? l.getContent() : j.attr.apply(b(p), arguments)
            }
        }
    }
})(jQuery);
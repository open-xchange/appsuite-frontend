...
tinymce.PluginManager.add('oxpaste', function (editor) {
    /*
    ...
    editor.on('paste', function (e) {
        ...
        if (clipboard) {
            ...
            _(items).each(function (item) {
                ...
                _.defer(function () {
                    tinyMCE.activeEditor.plugins.oximage.uploadBlob(file)
                });
            });
        }
    });
    ...
    editor.on('PastePostProcess', function (e) {
        $('img', $(e.node)).each(function (index, elem) {
            ...
            if (/^data:/.test(src)) {
                ...
                tinyMCE.activeEditor.plugins.oximage.uploadBlob(new Blob([intArray], { type: mimeString }));
            ...
            } else if ($elem.attr('data-pending')) {
                // this image is already uploading and needs to be previewed
                tinyMCE.activeEditor.plugins.oximage.addImage({ src: src, id: $elem.attr('id') });
            }
        });
    });
});

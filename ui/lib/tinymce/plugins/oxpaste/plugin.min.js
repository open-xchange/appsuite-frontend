...
(function () {
    window.tinymce.PluginManager.add('oxpaste', function (editor) {
        ...
        editor.on('paste', function (e) {
            ...
            if (clipboard) {
                ...
                _(items).each(function (item) {
                    ...
                    _.defer(function () {
                        window.tinyMCE.activeEditor.plugins.oximage.uploadBlob(file, { from_clipboard: true });
                    });
                });
            }
        });
        ...
        */
        // only debounce for non ie browsers (see 54701)
        ...
        editor.on('PastePostProcess', wrapper(function (e) {
            $('img', $(e.node)).each(function (index, elem) {
                ...
                if (/^data:/.test(src)) {
                    ...
                    if (intArray.length) window.tinyMCE.activeEditor.plugins.oximage.uploadBlob(new Blob([intArray], { type: mimeString }));
                    ...
                    window.tinyMCE.activeEditor.plugins.oximage.addImage({ src: src, id: $elem.attr('id') });
                }
            });
        }, 0));
    });

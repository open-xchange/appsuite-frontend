        ...
        */
            ...
            require(['io.ox/mail/compose/inline-images', 'io.ox/core/yell'], function (inline, yell) {
                cache[id] = inline.api.inlineImage({ file: blob }).then(
                    function success(response) {
                        ...
                        currentImage.attr('src', url).removeAttr('data-pending data-id id from_clipboard').css('maxWidth', '100%').addClass('aspect-ratio');
        ...
        this.addImage = function (opt) {
            ...
            ed.undoManager.transact(function () {
                ...
                var attr = { src: opt.src, style: 'max-width: 100%;', class: 'aspect-ratio' + opt.id ? opt.id : '', id: opt.id, alt: '', 'data-pending': 'true', 'data-id': opt.id };

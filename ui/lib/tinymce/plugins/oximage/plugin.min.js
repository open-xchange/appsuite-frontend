...
tinymce.PluginManager.add('oximage', function (editor) {
            ...
            cache[id] = inline.api.inlineImage({ file: blob }).then(
                function success(response) {
                    ...
                    if (ed) {
                        ...
                        currentImage = $('#' + id, el).attr('src', url).removeAttr('data-pending id from_clipboard').css('maxWidth', '100%').addClass('aspect-ratio');
    ...
    this.addImage = function (opt) {
        ...
        ed.undoManager.transact(function () {
            ed.focus();
            var attr = { src: opt.src, style: 'max-width: 100%;', class: 'aspect-ratio', id: opt.id, alt: '', 'data-pending': 'true' };

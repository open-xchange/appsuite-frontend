    ...
    describe('Mail Utilities:', function () {
        ...
        describe('timestamp functions', function () {
            ...
            it('should return a date string for valid date', function () {
                ...
                expect(util.getTime(1379508350), 'getTime').to.be.equal('17.01.1970');
                expect(util.getDateTime(1379508350), 'getDateTime').to.be.equal('17.01.1970 00:11');
                expect(util.getFullDate(1379508350), 'getFullDate').to.be.equal('17.01.1970 00:11');
            });
        });

...
define(['io.ox/mail/detail/content', 'settings!io.ox/mail'], function (content, settings) {
    ...
    describe('Mail content processing', function () {
        ...
        it('should detect email addresses (text/plain)', function () {
            ...
            expect(result.content.html()).toBe('test<br><a href="mailto:otto.xantner@open-xchange.com">otto.xantner@open-xchange.com</a><br>test');
        });
        ...
        it('should detect email addresses (text/html; @)', function () {
            ...
            expect(result.content.html()).toBe('<p><a href="mailto:otto.xantner@open-xchange.com">otto.xantner@open-xchange.com</a></p>');
        });
        ...
        it('should detect email addresses (text/html; &#64;)', function () {
            ...
            expect(result.content.html()).toBe('<p><a href="mailto:otto.xantner@open-xchange.com">Otto Xantner</a></p>');
        });

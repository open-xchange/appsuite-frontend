...
define(['io.ox/mail/detail/content', 'settings!io.ox/mail'], function (content, settings) {
    ...
    describe('Mail content processing', function () {
        ...
        it('should detect folder links (html, old-school)', function () {
            ...
            expect(result.content.html()).toBe('<p>Link: <a role="button" href="http://localhost/appsuite/?foo#m=infostore&amp;f=1234" target="_blank" class="deep-link btn btn-primary btn-xs deep-link-files" style="font-family: Arial; color: white; text-decoration: none;">Ordner</a>.</p>');
        });
        ...
        it('should detect folder links (html)', function () {
            ...
            expect(result.content.html()).toBe('<p>Link: <a role="button" href="http://localhost/appsuite/#app=io.ox/files&amp;folder=1337" target="_blank" class="deep-link btn btn-primary btn-xs deep-link-files" style="font-family: Arial; color: white; text-decoration: none;">Ordner</a>.</p>');
        });
        ...
        it('should detect folder links (html, variant)', function () {
            ...
            expect(result.content.html()).toBe('<p>Link: <a role="button" href="http://localhost/appsuite/#app=io.ox/files&amp;perspective=fluid:icon&amp;folder=1337" target="_blank" class="deep-link btn btn-primary btn-xs deep-link-files" style="font-family: Arial; color: white; text-decoration: none;">Ordner</a>.</p>');
        });
        ...
        it('should detect file links (html, old-school)', function () {
            ...
            expect(result.content.html()).toBe('<p>Link: <a role="button" href="http://localhost/appsuite/?foo#m=infostore&amp;f=1234&amp;i=0" target="_blank" class="deep-link btn btn-primary btn-xs deep-link-files" style="font-family: Arial; color: white; text-decoration: none;">Datei</a>.</p>');
        });
        ...
        it('should detect file links (html)', function () {
            ...
            expect(result.content.html()).toBe('<p>Link: <a role="button" href="http://localhost/appsuite/#app=io.ox/files&amp;folder=1337&amp;id=0" target="_blank" class="deep-link btn btn-primary btn-xs deep-link-files" style="font-family: Arial; color: white; text-decoration: none;">Datei</a>.</p>');
        });
        ...
        it('should detect file links (html, variant)', function () {
            ...
            expect(result.content.html()).toBe('<p>Link: <a role="button" href="http://localhost/appsuite/#app=io.ox/files&amp;perspective=fluid:icon&amp;folder=1337&amp;id=0" target="_blank" class="deep-link btn btn-primary btn-xs deep-link-files" style="font-family: Arial; color: white; text-decoration: none;">Datei</a>.</p>');
        });
        ...
        it('should detect appointment links (html, old-school)', function () {
            ...
            expect(result.content.html()).toBe('<p>Link: <a role="button" href="http://localhost/appsuite/?foo#m=calendar&amp;i=0&amp;f=1234" target="_blank" class="deep-link btn btn-primary btn-xs deep-link-calendar" style="font-family: Arial; color: white; text-decoration: none;">Termin</a>.</p>');
        });
        ...
        it('should detect appointment links (html)', function () {
            ...
            expect(result.content.html()).toBe('<p>Link: <a role="button" href="http://localhost/appsuite/#app=io.ox/calendar&amp;folder=1337&amp;id=0" target="_blank" class="deep-link btn btn-primary btn-xs deep-link-calendar" style="font-family: Arial; color: white; text-decoration: none;">Termin</a>.</p>');
        });
        ...
        it('should detect task links (html, old-school)', function () {
            ...
            expect(result.content.html()).toBe('<p>Link: <a role="button" href="http://localhost/appsuite/?foo#m=tasks&amp;i=0&amp;f=1234" target="_blank" class="deep-link btn btn-primary btn-xs deep-link-tasks" style="font-family: Arial; color: white; text-decoration: none;">Aufgabe</a>.</p>');
        });
        ...
        it('should detect task links (html)', function () {
            ...
            expect(result.content.html()).toBe('<p>Link: <a role="button" href="http://localhost/appsuite/#app=io.ox/tasks&amp;id=1337.0&amp;folder=1337" target="_blank" class="deep-link btn btn-primary btn-xs deep-link-tasks" style="font-family: Arial; color: white; text-decoration: none;">Aufgabe</a>.</p>');
        });
    });
});

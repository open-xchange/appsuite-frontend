...
define(['io.ox/mail/detail/links'], function (links) {
    ...
    describe('Mail Content detail Link recoginition', function () {
        ...
        it('recognizes a simple URL (http)', function () {
            ...
            expect(html).to.equal('Hoi <a href="http://yeah.html" target="_blank" rel="noopener">http://yeah.html</a>!');
        });

        it('recognizes a simple URL (https)', function () {
            var html = process('Hoi https://yeah.html!');
            expect(html).to.equal('Hoi <a href="https://yeah.html" target="_blank" rel="noopener">https://yeah.html</a>!');
        });

        it('recognizes a simple URL (www)', function () {
            var html = process('Hoi www.google.de!');
            expect(html).to.equal('Hoi <a href="http://www.google.de" target="_blank" rel="noopener">www.google.de</a>!');
        });

        it('recognizes a complex URL', function () {
            var html = process('Hoi https://yeah.html/path/file#hash!');
            expect(html).to.equal('Hoi <a href="https://yeah.html/path/file#hash" target="_blank" rel="noopener">https://yeah.html/path/file#hash</a>!');
        });
        ...
        it('recognizes multiple links', function () {
            ...
            expect(html).to.equal('Hoi <a href="http://yeah.html" target="_blank" rel="noopener">http://yeah.html</a>! test <a href="http://test/foo#m=calendar&amp;f=1&amp;i=1337" target="_blank" class="deep-link deep-link-calendar" role="button">Termin</a> foo <a href="mailto:icke@domain.foo" class="mailto-link" target="_blank">Jon doe</a> END.');
        });
        ...
        it('recognizes multiple links (not greedy)', function () {
            ...
            expect(html).to.equal('Das hier ist ohne prefix am Satzende <a href="http://www.google.de" target="_blank" rel="noopener">www.google.de</a>. Und das <a href="http://www.google.de" target="_blank" rel="noopener">www.google.de</a> mitten im Satz. und mit prefix <a href="http://www.google.de" target="_blank" rel="noopener">http://www.google.de</a>.');
        });

define([
    ...
    describe.only('Text processing toolkit', function () {
        describe('htmltotext', function () {
            describe.skip('should handle links', function () {
            ...
            it('should transform links', function () {

...
define('io.ox/core/viewer/types/basetype',  [
    ...
    /**
     * Default file type for OX Viewer. Implements the ViewerType interface.
     *
    ...
    function BaseType() {
        ...
        this.createSlide = function (model, modelIndex) {
            //console.warn('BaseType.createSlide()');
        ...
        this.loadSlide = function (slideIndex, slideElement) {
            //console.warn('BaseType.loadSlide()', slideIndex, slideElement);

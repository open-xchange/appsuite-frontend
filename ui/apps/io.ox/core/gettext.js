...
define('io.ox/core/gettext', function () {
    ...
    function gt(id, po) {
        ...
        function get(key) {
            if (!enabled && ox.debug && /custom-translations/.test(_.url.hash('debug'))) {
                console.error('Early gettext call: ' + JSON.stringify(key) + '. This string cannot be replaced by custom translations.');
            }

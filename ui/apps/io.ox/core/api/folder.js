...
define(
        ...
        ['io.ox/core/http', 'io.ox/core/cache', 'io.ox/core/config'],
        function (http, cache, config) {

            'use strict';

            var // folder object cache
            folderCache = new cache.SimpleCache('folder', true), subFolderCache = new cache.SimpleCache(
                    'subfolder', true),
            ...
            var api = {
                ...
                getSubFolders: function (options) {
                    ...
                    var getter = function () {
                        return http.GET({
                            ...
                            _(data).each(function (folder) {
                                ...
                                function (error) {
                                    console.error('folder.getSubFolders',
                                            opt.folder, error);
                                });
                    };
                    ...
                    if (opt.cache === false) {
                        ...
                        return cache.contains(opt.folder).pipe(
                                function (check) {
                                    if (check) {

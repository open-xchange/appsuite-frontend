...
define('io.ox/backbone/mini-views/colorpicker', [
    ...
    var defaultColors = [
            ...
            { value: '#FF0000', name: gt('Red') }, { value: '#FF9900', name: gt('Amber') }, { value: '#99CC00', name: gt('Yellow green') }, { value: '#339966', name: gt('Sea green') }, { value: '#33CCCC', name: gt('Turquoise') }, { value: '#3366FF', name: gt('Royal blue') }, { value: '#800080', name: gt('Purple') }, { value: 'transparent', name: gt('No color') }

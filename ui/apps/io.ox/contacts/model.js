...
define('io.ox/contacts/model',
    ...
    var contactSchema = new Model.Schema({
        ...
        'telephone_business2': { format: 'string', label: gt('Phone 2')},
        ...
        'telephone_home1': { format: 'string', label: gt('Phone')},
        'telephone_home2': { format: 'string', label: gt('Phone 2')},
        'fax_home': { format: 'string', label: gt('Fax')},
        'cellular_telephone1': { format: 'string', label: gt('Cell phone'), mandatory: true},
        'cellular_telephone2': { format: 'string', label: gt('Cell phone')},
        'telephone_other': { format: 'string', label: gt('Phone (other)')},
        'fax_other': { format: 'string', label: gt('Fax (other)')},
        'email1': { format: 'email', label: gt('Email 1'), mandatory: true},
        ...
        'instant_messenger1': { format: 'string', label: gt('Instant Messenger')},
        'instant_messenger2': { format: 'string', label: gt('Instant Messenger')},

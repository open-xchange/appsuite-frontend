...
define('io.ox/contacts/model',
    ...
    var fields = {
        ...
        number_of_links: gt('Number of links'),
        number_of_images: gt('Number of images'),
        image_last_modified: gt('Image last modified'),
        state_other: gt('State'),
        file_as: gt('File as'),
        image1_content_type: gt('Image1 content type'),
        mark_as_distributionlist: gt('Mark as distributionlist'),
        default_address: gt('Default address'),
        image1_url: gt('Image1 url'),
        internal_userid: gt('Internal userid'),
        useCount: gt('use Count'),
        yomiFirstName: gt('yomi First Name'),
        yomiLastName: gt('yomi Last Name'),

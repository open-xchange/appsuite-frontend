...
//                          select the data
                ...
                $('<button>').text('save')
                    .addClass('io-ox-button')
                    .on('click', save)
                    .appendTo(paneUpdate2);
                ...
                $('.contact_update_frame .block .field:nth-child(even)').addClass('even');

                $('.contact_update_frame .edit_contact input').each(function (index) {

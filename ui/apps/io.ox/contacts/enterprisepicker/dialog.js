...
define('io.ox/contacts/enterprisepicker/dialog', [
    ...
    var columns = '20,1,101,500,501,502,505,519,520,521,522,524,542,543,547,548,549,551,552,553,555,556,557,569,602,606,607,616,617,5,2';
    ...
    var open = function (callback) {
        ...
        defs.push(folderApi.list(folderApi.getDefaultFolder('contacts'), { all: true }));
        ...
        return $.when.apply($, defs).then(function (folders) {
            ...
            settings.set('lastSearchedContacts', _(lastSearchedContacts).pluck('id', 'folder_id')).save();

...
define('io.ox/office/tk/dropdown/sizer',
     ...
     * containing a size chooser. Extends the Menu mix-in class with
     * functionality specific to the sizer drop-down element.
     *
     * @extends Menu
     *
     * @param {Group} group
    ...
    function extend(group, options) {
        ...
        group.getMenuNode().addClass('size-chooser').append(gridButton);

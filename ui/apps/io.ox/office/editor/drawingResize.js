...
define('io.ox/office/editor/drawingResize',
    ...
    DrawingResize.drawDrawingSelection = function (editor, drawing) {
         ...
         *
         */
        function mouseDownOnMoveableNodeHandler(e1, e2) {
            ...
            if (selectionBox.length === 0) {
                ...
                if (options.sizeable) {
                    ...
                    _(['tl', 't', 'tr', 'r', 'br', 'b', 'bl', 'l']).each(function (pos) {
                        var handleDiv = null;
                        handleDiv = $('<div>').on('mousedown', {pos: pos}, mouseDownOnResizeNodeHandler);
                ...
                if (options.moveable) {
                    // moving the drawing
                    $(this).on('mousedown', mouseDownOnMoveableNodeHandler);
                }

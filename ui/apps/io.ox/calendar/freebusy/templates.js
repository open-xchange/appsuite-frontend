...
define('io.ox/calendar/freebusy/templates', ['gettext!io.ox/calendar/freebusy'], function (gt) {
    ...
    return {
            ...
            return $('<a href="#" class="hint pull-left" tabindex="2">')
                ...
                .popover({
                    content: gt(
                        ...
                        'You will automatically return to the appointment. The selected start and end time will be applied.'
                    ),
                    html: true,
                    placement: 'top',
                    title: gt('Hint'),
        ...
        getBackButton: function () {
            return $('<button class="btn pull-right" tabindex="3">').text(gt('Back to appointment'));
        }
    };
});

...
define('plugins/playground/fluppi/register',
    ...
    console.info('Loaded portal plugin: fluppi');

    ext.point('io.ox/portal/widget').extend({ id: 'fluppi' });

    ext.point('io.ox/portal/widget/fluppi').extend({
        ...
        plugin: 'plugins/playground/fluppi/register'
    });

    ext.point('io.ox/portal/widget/fluppi/settings').extend({
        title: gt('Fluppi'),
        type: 'fluppi',
        editable: false
    });

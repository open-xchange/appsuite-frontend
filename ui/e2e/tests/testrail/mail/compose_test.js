...
Scenario('C1337 - import mail', async function (I, users) {
    ...
    const data = await I.importMail({ user: users[0] }, 'default0/INBOX', 'e2e/tests/testrail/files/mail/mail_testcases_C101616_C101616.eml')
    //console.log(data)
...
Scenario('C101615 - Emojis', async function (I, users) {
    ...
    const data = await I.importMail({ user: users[0] }, 'default0/INBOX', 'e2e/tests/testrail/files/mail/badmails/C101615/C101615.eml')
    //console.log(data)
...
Scenario('C101617 - Mail with <strike> element </strike>', async function (I, users) {
    ...
    const data = await I.importMail({ user: users[0] }, 'default0/INBOX', 'e2e/tests/testrail/files/mail/badmails/C101617/C101617.eml')
    //console.log(data)
...
Scenario('C101620 - Very long TO field', async function (I, users) {
    ...
    const data = await I.importMail({ user: users[0] }, 'default0/INBOX', 'e2e/tests/testrail/files/mail/badmails/C101620/C101620.eml')
    //console.log(data)
...
Scenario('C101619 - CSS a:link test', async function (I, users) {
    ...
    const data = await I.importMail({ user: users[0] }, 'default0/INBOX', 'e2e/tests/testrail/files/mail/badmails/C101619/C101619.eml')
    //console.log(data)
...
Scenario('C273801 - Download infected file', async function (I, users) {
    ...
    const data = await I.importMail({ user: users[0] }, 'default0/INBOX', 'e2e/tests/testrail/files/mail/Virus_attached!.eml')
    //console.log(data)
...
Scenario('C114958 - Delete draft when closing composer', async function (I, users) {
    ...
    const data = await I.importMail({ user: users[0] }, 'default0/INBOX/Drafts', 'e2e/tests/testrail/files/mail/Virus_attached!.eml')

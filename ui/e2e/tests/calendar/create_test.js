...
Scenario('[C7428] Create appointment with internal participants @flaky', async function (I, users, calendar) {
...
// TODO: shaky, failed at least once (10 runs on 2019-11-28)
Scenario('[C7429] Create appointment via Contact @flaky', async function (I, users, contacts, calendar) {
...
// TODO: shaky, failed at least once (10 runs on 2019-11-28)
Scenario('[C7431] Create appointment via doubleclick @flaky', async function (I, calendar) {
...
// TODO: shaky, failed at least once (10 runs on 2019-11-28)
Scenario('[C7413] Create appointment with an attachment @flaky', async function (I, calendar) {
...
// TODO: shaky, failed at least once (10 runs on 2019-11-28)
Scenario('[C7447] Private appointment with participants @flaky', async function (I, users, calendar) {
    I.haveSetting('io.ox/core//autoOpenNotification', false);
    I.haveSetting('io.ox/core//showDesktopNotifications', false);
    I.haveSetting('io.ox/calendar//viewView', 'week:week');
...
// TODO: shaky, failed at least once (10 runs on 2019-11-28)
Scenario('[C234658] Create appointments and show this in cumulatively view @flaky', async function (I, calendar) {
    const

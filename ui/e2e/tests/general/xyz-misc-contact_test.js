...
Scenario('xyz Subscribe and unsubscribe shared address book', async function ({ I, users, contacts }) {
    ...
    await users[0].hasConfig('com.openexchange.carddav.enabled', true);

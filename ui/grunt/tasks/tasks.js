...
module.exports = function (grunt) {
    ...
    var tasks = ['lint', 'workaround_fetch', 'copy_build', 'uglify:build_dompurify'];
    ...
    grunt.registerTask('dist:build', ['clean', 'copy_build', 'uglify:build_dompurify', 'compile_po', 'concat', 'uglify', 'version_txt', 'copy_dist', 'create_i18n_properties']);
